...
#ifndef AIDLABSDK_SWIFT_H
#define AIDLABSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AidlabSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9AidlabSDK6Aidlab")
@interface Aidlab : NSObject <AidlabInteropDelegate, CBPeripheralDelegate>
...
- (void)sendFirmwareChunk:(uint8_t * _Null_unspecified)buffer;
- (void)didReceiveECG:(uint64_t)timestamp values:(float * _Null_unspecified)values size:(int32_t)size;
- (void)didReceiveRespiration:(uint64_t)timestamp values:(float * _Null_unspecified)values size:(int32_t)size;
...
- (void)didReceiveHeartRate:(uint64_t)timestamp hrv:(int32_t * _Null_unspecified)hrv heartRate:(int32_t)heartRate;
...
- (void)didReceivePastECG:(uint64_t)timestamp values:(float * _Null_unspecified)values size:(int32_t)size;
- (void)didReceivePastRespiration:(uint64_t)timestamp values:(float * _Null_unspecified)values size:(int32_t)size;
- (void)didReceivePastSkinTemperature:(uint64_t)timestamp value:(float)value;
- (void)didReceivePastHeartRate:(uint64_t)timestamp hrv:(int32_t * _Null_unspecified)hrv heartRate:(int32_t)heartRate;
- (void)syncStateDidChange:(SyncState)state;
...
SWIFT_CLASS("_TtC9AidlabSDK9AidlabSDK")
@interface AidlabSDK : NSObject <CBCentralManagerDelegate>
